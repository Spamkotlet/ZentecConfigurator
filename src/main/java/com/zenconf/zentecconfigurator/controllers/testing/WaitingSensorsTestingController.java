...
public class WaitingSensorsTestingController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        forwardButton.setOnAction(e -> {
            ...
            try {
                Node testingPanel = FXMLLoader.load(Application.class.getResource("fxml/testing/check-list-testing.fxml"));
