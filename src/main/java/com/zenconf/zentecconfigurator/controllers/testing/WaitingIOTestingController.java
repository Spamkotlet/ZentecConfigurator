...
public class WaitingIOTestingController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        forwardButton.setOnAction(e -> {
            ...
            try {
                Node testingPanel = FXMLLoader.load(Application.class.getResource("fxml/testing/waiting-sensors-testing.fxml"));
